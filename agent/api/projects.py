...
def _extract_project_id(payload):
    """Walk nested tRPC payloads and return the first projectId found."""
    if isinstance(payload, dict):
        ...
        if isinstance(project, dict):
            nested_id = project.get("projectId") or project.get("id")
...
async def create(body: ProjectCreate):
    ...
    flow_project_id = _extract_project_id(flow_result.get("data"))
