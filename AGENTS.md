...
- **Read First:** Read [.ai/keyword-router.md](file:///c:/Users/USER/Desktop/_ref_flowkit/.ai/keyword-router.md) before acting on any short commands or bug-related phrases (e.g., "fix this bug", "macam mana ni").
- **Formal Task:** Treat "fix this bug" and all equivalent phrases as a formal debugging task.
- **Contract Loading:** Immediately load [.ai/contracts/DEBUG_CONTRACT.md](file:///c:/Users/USER/Desktop/_ref_flowkit/.ai/contracts/DEBUG_CONTRACT.md).
- **Chrome Extension Context:** For any Chrome Extension MV3 bugs, you must also load [.ai/contracts/CHROME_EXTENSION_MV3_DEBUG_CONTRACT.md](file:///c:/Users/USER/Desktop/_ref_flowkit/.ai/contracts/CHROME_EXTENSION_MV3_DEBUG_CONTRACT.md).
- **No Early Patching:** NEVER apply a patch before proving the failure path and establishing evidence.
