...
FILE_TYPE_CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "export_ad_list": {
        ...
        "optional_columns": ["Product Name", "Shop Name", "Orders", "Total Units Sold", "Video ID", "Video Url", "Homepage"],
        "sample_columns": ["Handle", "Video ID", "Description"],
    },
    "export_advertiser_list": {
        ...
        "optional_columns": ["Shop Name", "Total Sales Volume", "Shop Units Sold", "Orders", "Seller ID"],
        "sample_columns": ["Name", "Ad Revenue", "Product Count"],
    },
    "shop_list": {
    ...
    "sales_rank": {
        ...
        "required_columns": ["Shop Name"],
        "optional_columns": ["Product Name", "Total Units Sold", "Shop Total Units Sold", "Orders", "FastMoss Shop Detail Page Link"],
        "sample_columns": ["Shop Name", "Sales [-]", "Revenue [-]"],
    },
    "new_products_ranking": {
