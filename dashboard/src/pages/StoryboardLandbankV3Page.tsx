	...
	const handleApprove = async () => {
		...
		try {
			if (bulkApproval) {
				...
				setSuccess(`Human batch approval receipt recorded for ${response.approved_count} storyboard(s). No V2 activation or materialization was performed.`);
			} else {
